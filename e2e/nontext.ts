...
export async function auditNonText(page: Page, within = 'body *'): Promise<NonTextFailure[]> {
  return page.evaluate((rootSelector) => {
     ...
     *
     * A driven pass here walks five exhibits, a ring of up to eleven nodes, one
     * response chip and one challenge span per ring member, a growing ledger and
     * a scatter chart — thousands of sibling elements all re-walking the same
